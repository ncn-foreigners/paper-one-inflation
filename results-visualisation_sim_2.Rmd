...
ggsave(plot = pp, filename = paste0(dir, "/figures/fitted_proportion.png"), width = 6, height = 8)
ggsave(plot = p1, filename = paste0(dir, "/figures/ztoipoisson.png"), width = 6, height = 8)
ggsave(plot = p2, filename = paste0(dir, "/figures/oiztpoisson.png"), width = 6, height = 8)
ggsave(plot = p3, filename = paste0(dir, "/figures/ztHurdlepoisson.png"), width = 6, height = 8)
ggsave(plot = p4, filename = paste0(dir, "/figures/Hurdleztpoisson.png"), width = 6, height = 8)
ggsave(plot = p5, filename = paste0(dir, "/figures/ztoigeom.png"), width = 6, height = 8)
ggsave(plot = p6, filename = paste0(dir, "/figures/oiztgeom.png"), width = 6, height = 8)
ggsave(plot = p7, filename = paste0(dir, "/figures/ztHurdlegeom.png"), width = 6, height = 8)
ggsave(plot = p8, filename = paste0(dir, "/figures/Hurdleztgeom.png"), width = 6, height = 8)
ggsave(plot = p9, filename = paste0(dir, "/figures/ztoinegbin.png"), width = 6, height = 8)
ggsave(plot = p10, filename = paste0(dir, "/figures/oiztnegbin.png"), width = 6, height = 8)
ggsave(plot = p11, filename = paste0(dir, "/figures/ztHurdlenegbin.png"), width = 6, height = 8)
ggsave(plot = p12, filename = paste0(dir, "/figures/Hurdleztnegbin.png"), width = 6, height = 8)
```
...
dir <- paste(strsplit(getwd(), split = "/")[[1]][1:5], collapse = "/")
ggsave(plot = qq1, filename = paste0(dir, "/figures/confint_normal_coverage.png"), width = 6, height = 8)
ggsave(plot = qq2, filename = paste0(dir, "/figures/confint_normal_size.png"), width = 6, height = 8)
ggsave(plot = qq3, filename = paste0(dir, "/figures/confint_log_normal_coverage.png"), width = 6, height = 8)
ggsave(plot = qq4, filename = paste0(dir, "/figures/confint_log_normal_size.png"), width = 6, height = 8)
```